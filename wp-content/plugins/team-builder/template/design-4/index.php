...
<style>
		...
		#wpsm_team_1_b_row_<?php echo $PostId; ?> .wpsm_team_1_member_wrapper
		{
			margin:10px;
		}
		#wpsm_team_1_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot span {			
			background:<?php echo $team_car_dots_bg_clr; ?>;			
		}
		#wpsm_team_1_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot.active span {
			background: <?php echo $team_car_dots__hvr_bg_clr; ?>;
		}
		#wpsm_team_1_b_row_<?php echo $PostId; ?> .owl-dots
		{
			<?php
		...
		#wpsm_team_1_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot:hover span {
			background: <?php echo $team_car_dots__hvr_bg_clr; ?>;
		}
		...
		#wpsm_team_1_b_row_<?php echo $PostId; ?>  p{
			color:<?php echo $team_mb_desc_clr; ?> !important;
			font-size:<?php echo $team_mb_desc_ft_size; ?>px !important;
			<?php if($font_family!="0") { ?>
			   font-family:'<?php echo $font_family; ?>';
