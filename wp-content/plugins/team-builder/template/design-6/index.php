<?php if ( ! defined( 'ABSPATH' ) ) exit; ?>
	...
	<style>
			...
			#wpsm_team_3_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot span {			
			background:<?php echo $team_car_dots_bg_clr; ?>;			
			}
			#wpsm_team_3_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot.active span {
				background: <?php echo $team_car_dots__hvr_bg_clr; ?>;
			}
			#wpsm_team_3_b_row_<?php echo $PostId; ?> .owl-dots .owl-dot:hover span {
				background: <?php echo $team_car_dots__hvr_bg_clr; ?>;
			}
			#wpsm_team_3_b_row_<?php echo $PostId; ?> .owl-dots
			{
				<?php
