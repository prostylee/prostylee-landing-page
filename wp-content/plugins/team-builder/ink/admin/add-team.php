...
<style>
	...
	.wpsm_home_portfolio_showcase_a
	{
...
<div style=" overflow: hidden;padding: 20px;margin-bottom:30px;">
			...
			<div class="demoftr">	
				...
				<div class="">
					<div class="wpsm_home_portfolio_showcase">
						...
						<span style="position: absolute;bottom: 0px;width: 30%;overflow: hidden; text-align: center; background: rgba(0,0,0,0.8); padding-top: 5px; padding-bottom: 5px;  color: #fff;  border-top-left-radius: 15px; font-size: 13px; right: 0;"><a style="color:#fff;text-decoration:none" target="_blank" href="http://demo.wpshopmart.com/team-builder/demo-<?php echo $i; ?>/">Demo</a></span>
					</div>
				</div>
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
					<h3 class="text-center pull-left" style="margin-top: 10px;margin-bottom: 10px;font-weight:900">Design <?php if($i==4) { echo '1 + Carousel'; } else if($i==5){ echo '2 + Carousel'; } else if($i==6){ echo '3 + Carousel'; } else { echo $i; } ?>
	...
	<div class="col-md-4">
			...
			<div class="demoftr">	
				...
				<div class="">
					<div class="wpsm_home_portfolio_showcase">
						<div class="wpsm_ribbon wpsm_ribbon2"><a target="_blank" href="http://demo.wpshopmart.com/team-pro-demo/slider-list/"><span>Available In Pro</span></a></div>
						...
						<img class="wpsm_img_responsive ftr_img" src="<?php echo wpshopmart_team_b_directory_url.'assets/images/c2.png'?>"></a>
    ...
    font-size: 13px;
    right: 0;"><a style="color:#fff;text-decoration:none" target="_new" href="http://demo.wpshopmart.com/team-pro-demo/slider-list/">Demo</a></span>
					</div>
				</div>
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
					<h3 class="text-center pull-left" style="margin-top: 10px;margin-bottom: 10px;font-weight:900">Carousel</h3>
					<a  class="pull-right btn btn-primary design_btn wpsm_home_portfolio_showcase_a" href="https://wpshopmart.com/plugins/team-pro/" target="_blank" style="    background-color: #e0bf1b;    border-color: #e0bf1b;">Get In Pro</a>
				</div>		
			</div>
		...
		<div class="col-md-4">
			...
			<div class="demoftr">	
				...
				<div class="">
					<div class="wpsm_home_portfolio_showcase">
						<div class="wpsm_ribbon wpsm_ribbon2"><a target="_blank" href="http://demo.wpshopmart.com/team-pro-demo/"><span>Available In Pro</span></a></div>
						
						<a   href="http://demo.wpshopmart.com/testimonial-pro-demo" target="_blank" >
						<img class="wpsm_img_responsive ftr_img" src="<?php echo wpshopmart_team_b_directory_url.'assets/images/table.jpg'?>"></a>
						<span class="img-demo-span" style="position: absolute;
    bottom: 0px;
    width: 30%;
    overflow: hidden;
    ...
    border-top-left-radius: 15px;
    font-size: 13px;
    right: 0;"><a style="color:#fff;text-decoration:none" target="_blank" href="http://demo.wpshopmart.com/team-pro-demo/tabular/">Demo</a></span>
					</div>
				</div>
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
					<h3 class="text-center pull-left" style="margin-top: 10px;margin-bottom: 10px;font-weight:900">Table Layout</h3>
					<a  class="pull-right btn btn-primary design_btn wpsm_home_portfolio_showcase_a" href="https://wpshopmart.com/plugins/team-pro/" target="_blank" style="    background-color: #e0bf1b;    border-color: #e0bf1b;">Get In Pro</a>
				</div>		
			</div>
			...
			<div class="demoftr">	
				...
				<div class="">
					<div class="wpsm_home_portfolio_showcase">
						...
						<a   href="http://demo.wpshopmart.com/testimonial-pro-demo" target="_blank" >
						<img class="wpsm_img_responsive ftr_img" src="<?php echo wpshopmart_team_b_directory_url.'assets/images/3rd.jpg'?>"></a>
						<span class="img-demo-span" style="position: absolute;
    bottom: 0px;
    width: 30%;
    overflow: hidden;
    ...
    border-top-left-radius: 15px;
    font-size: 13px;
    right: 0;"><a style="color:#fff;text-decoration:none" target="_blank" href="http://demo.wpshopmart.com/team-pro-demo">Demo</a></span></div>
				</div>
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
				...
				foreach($All_data as $single_data)
				{
					...
					<li class="wpsm_ac-panel single_color_box" >
						...
						<div class="col-md-4">
								...
								<span class="ac_label"><?php _e('Instagram Profile Url',wpshopmart_team_b_text_domain); ?></span>
								<input type="text"  name="mb_gp_url[]" value="<?php echo esc_attr($mb_gp_url); ?>" placeholder="Enter Member Instagram profile url with http://" class="wpsm_ac_label_text">
