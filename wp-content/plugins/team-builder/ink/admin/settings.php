	...
	<tbody>
		...
		<tr class="setting_color">
			...
			<td>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px; line-height: 22px;" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Unlock More Settings and feature in Premium Version</a> </div>
			...
			<td>
				<select name="font_family" id="font_family" class="standard-dropdown" style="width:100%" >
					<optgroup label="Default Fonts">
						...
						<option value="0"        <?php if($font_family == '0' ) { echo "selected"; } ?>>Theme Default Style</option>
					</optgroup>
				</select>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px;line-height: 22px;" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Get 500+ Google Fonts In Premium Version</a> </div>
		...
		<tr>
			...
			<td>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px;line-height: 22px;" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Get More 6+ More Column Layout In Premium Version</a> </div>
		...
		<tr>
			...
			<td>
				<input id="team_car_dots_bg_clr" name="team_car_dots_bg_clr" type="text" value="<?php echo $team_car_dots_bg_clr; ?>" class="my-color-field" data-default-color="#D6D6D6" />
				<div id="team_car_dots_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						...
						<img src="<?php echo wpshopmart_team_b_directory_url.'assets/tooltip/img/dots.png'; ?>">
					</div>
		    	</div>
		...
		<tr>
			...
			<td>
				<input id="team_car_dots__hvr_bg_clr" name="team_car_dots__hvr_bg_clr" type="text" value="<?php echo $team_car_dots__hvr_bg_clr; ?>" class="my-color-field" data-default-color="#869791" />
				<div id="team_car_dots__hvr_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						...
						<img src="<?php echo wpshopmart_team_b_directory_url.'assets/tooltip/img/dothover.png'; ?>">
					</div>
		    	</div>
