<?php get_header();?>
    <section id="feature-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 introduction">
                    <h2 class="text-title">
                ...
                <!-- end introduction -->
                <div class="col-xs-12 col-sm-12 col-md-6 banners">
    ...
    <main id="main-wrapper">
        <section class="component choose-us-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12 inner-choose-us">
                ...
                <div class="row">
                    <div class="col-md-6 section-left using-phone">
                    ...
                    <div class="col-md-6 section-right benefits">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <span class="icon-item"><img src="<?php echo get_template_directory_uri();?>/assets/images/sample.png" alt=""></span>
                                <span class="text">Đơn giản và dễ dùng</span>
                            </li>
                            <li class="list-group-item">
                                <span class="icon-item"><img src="<?php echo get_template_directory_uri();?>/assets/images/quickly.png" alt=""></span>
                                <span class="text">Nhanh chóng, an toàn</span></li>
                            </li>
                            <li class="list-group-item">
                                <span class="icon-item"><img src="<?php echo get_template_directory_uri();?>/assets/images/anywhere.png" alt=""></span>
                                <span class="text">Mọi lúc mọi nơi</span>
                            </li>
                            </li>
                            <li class="list-group-item">
                                <span class="icon-item"><img src="<?php echo get_template_directory_uri();?>/assets/images/good_brand.png" alt=""></span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 section-right">
                            ...
                            <p class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et sem ac purus elementum pharetra. Sed a ex maximus, dignissim augue nec, fringilla libero. Nam ultricies euismod elit vitae convallis. Curabitur cursus dignissim.</p>
                        </div>
                    </div>
                </div>
                <!-- end container -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 section-right">
                            ...
                            <p class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et sem ac purus elementum pharetra. Sed a ex maximus, dignissim augue nec, fringilla libero. Nam ultricies euismod elit vitae convallis. Curabitur cursus dignissim.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 section-right">
                            <div class="box-image">
                                <a href=""><img src="<?php echo get_template_directory_uri();?>/assets/images/product_post.png" alt=""></a>
                            </div>
                            <!-- end box-image -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 section-left">
                            <span class="icon"><img src="<?php echo get_template_directory_uri();?>/assets/images/post_icon.png" alt=""></span>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img src="<?php echo get_template_directory_uri();?>/assets/images/step_1.png" alt="" class="card-img-bottom"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer quis eros et purus pretium fringilla.</p>
                                <img src="<?php echo get_template_directory_uri();?>/assets/images/step_2.png" alt="" class="card-img-bottom"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer quis eros et purus pretium fringilla.</p>
                                <img src="<?php echo get_template_directory_uri();?>/assets/images/step_3.png" alt="" class="card-img-bottom"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="box-content partners">
                       <?php
                        echo do_shortcode('[logo-slider cat="row-1" loop="no" autoplay="no" navmobile="no" dots="no" itemlarge="6" border="yes"]');
                       echo do_shortcode('[logo-slider cat="row-1" loop="no" autoplay="no" navmobile="no" dots="no" itemlarge="6" border="yes"]');
                       echo do_shortcode('[logo-slider cat="row-1" loop="no" autoplay="no" navmobile="no" dots="no" itemlarge="6" border="yes"]');
                       ?>
                    </div>
