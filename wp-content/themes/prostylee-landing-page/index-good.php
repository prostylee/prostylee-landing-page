...
<div id="prostylee-wrapper">
    ...
    <main id="main-wrapper">
        <section class="component choose-us-section">
            <div class="container">
                <div class="row">
                    <div class="offset-md-6 col-md-6 col-sm-12 inner-choose-us">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="box-content partners">
                        <div class="card">
                            <a href=""><img src="<?php echo get_template_directory_uri();?>/assets/images/partner.png" class="card-img-top" alt=""></a>
                        </div>
                        <div class="card">
                            <a href=""><img src="<?php echo get_template_directory_uri();?>/assets/images/partner.png" class="card-img-top" alt=""></a>
                        </div>
